...
Managing this fairs can be very cumbersome for a University, and the user experience is often over-complicated for both the parties involved. UniTN Booking Bot aims to simplify the advertising and booking process of an event, using exclusivity a Telegram Bot. Thanks to it meetings will be arranged with a few taps on an app we use every day rather than having to pass through complex sites with multi-factor authentication, guaranteeing a faster and more efficient communication. This will translate into an higher user satisfaction and a streamlining of the event monitoring process.
...
The documentation is obtained compiling all the comments in the files according to a set of parameters defined in a \texttt{Doxyfile} in the root folder. The output is a full HTML site, ready to be exposed to the internet. In my case, I used the \textit{GitHub pages} of my repository to host it at the following address: https://alphanightlight.github.io/UnitnBookingBot
...
\bibitem{ptb-doc} Official documentation  of python-telegram-bot, last access 18 Feb 2026:\\ https://docs.python-telegram-bot.org/en/stable/index.html
\bibitem{sql-doc} Official documentation  of SQLite, last access 18 Feb 2026:\\ https://sqlite.org/index.html
\bibitem{sql-gg} Quick reference for SQLite, last access 18 Feb 2026:\\ https://www.geeksforgeeks.org/python/python-sqlite
\bibitem{doxygen-doc} Official documentation  of Doxygen, last access 18 Feb 2026:\\ https://www.doxygen.nl/manual/index.html
